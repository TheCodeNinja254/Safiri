                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="btn btn-primary" id="car_make_list" name="make" style="width:90%;" required>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="btn btn-primary" id="car_body_type_list" name="body_type" style="width:90%;" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="btn btn-primary" id="car_location_list" name="ad_car_location" style="width:90%;" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="btn btn-primary" id="car_pickup_point_list" name="pick_up_point" style="width:90%;" required>
